...
class _VideoSegmentState extends State<VideoSegment>
  ...
  void postInit() async {
    // get video
    await sc.getFile(bucket: 'chat_videos', fileId: widget.video).then((bytes) {
      if (!isDisposed) {
        setState(() {
          downloading = false;
        });
      ...
      _controller =
          VideoPlayerController.file(File.fromRawPath(bytes)) //widget.video)
                      ...
                      child: Center(
                        child: SizedBox(
                            ...
                            child: CircularProgressIndicator(
                              strokeWidth:
                                  _controller.value.isInitialized ? 1 : 2,
